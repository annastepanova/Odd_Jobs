...
class App extends React.Component {
  ...
  fetchCategories = async () => {
    const { data } = await axios.get("http://localhost:3000/job_categories", {
      headers: {
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJleHAiOjE1NzQ3OTEwNzR9.E59EUL0hLNW6jotSMBV22MUDsbkxv20kq4n4IDPOCKo"
      }
    });
      ...
      <div className="App">
        <BrowserRouter>
          ...
          <Switch>
            ...
            <Route exact path="/contractors/:id" component={ContractorPage} />
          </Switch>
        </BrowserRouter>
      </div>
    );
